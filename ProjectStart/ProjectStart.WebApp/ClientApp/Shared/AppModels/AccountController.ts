...
export const getRegister = (returnUrl: string = null, localData?: (data: any) => void): Promise<any> => Api(getRegisterActionId, 'get', `/Account/register?returnUrl=${encodeURIComponent(returnUrl)}`, null, true , localData);
...
export const postRegister = (model: RegisterViewModel, returnUrl: string = null, localData?: (data: any) => void): Promise<any> => Api(postRegisterActionId, 'post', `/Account/register?returnUrl=${encodeURIComponent(returnUrl)}`, model, true , localData);
