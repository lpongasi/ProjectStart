...
export const postLogin = (model: LoginViewModel, localData?: (data: Response) => void): Promise<Response> => Api(postLoginActionId, 'post', `/Account/login`, model, true , localData);
