...
export const getLogin = (returnUrl: string): Promise<any> => Api('get', `/Account/login?returnUrl=${encodeURIComponent(returnUrl)}`, null, getLoginActions);
...
export const postLogin = (model: LoginViewModel, returnUrl: string): Promise<Response> => Api('post', `/Account/login?returnUrl=${encodeURIComponent(returnUrl)}`, model, postLoginActions);
...
export const getLoginWith2fa = (rememberMe: boolean, returnUrl: string): Promise<any> => Api('get', `/Account/loginWith2fa?rememberMe=${rememberMe}&returnUrl=${encodeURIComponent(returnUrl)}`, null, getLoginWith2faActions);
...
export const postLoginWith2fa = (model: LoginWith2faViewModel, rememberMe: boolean, returnUrl: string): Promise<any> => Api('post', `/Account/loginWith2fa?rememberMe=${rememberMe}&returnUrl=${encodeURIComponent(returnUrl)}`, model, postLoginWith2faActions);
...
export const getLoginWithRecoveryCode = (returnUrl: string): Promise<any> => Api('get', `/Account/loginWithRecoveryCode?returnUrl=${encodeURIComponent(returnUrl)}`, null, getLoginWithRecoveryCodeActions);
...
export const postLoginWithRecoveryCode = (model: LoginWithRecoveryCodeViewModel, returnUrl: string): Promise<any> => Api('post', `/Account/loginWithRecoveryCode?returnUrl=${encodeURIComponent(returnUrl)}`, model, postLoginWithRecoveryCodeActions);
...
export const getRegister = (returnUrl: string): Promise<any> => Api('get', `/Account/register?returnUrl=${encodeURIComponent(returnUrl)}`, null, getRegisterActions);
...
export const postRegister = (model: RegisterViewModel, returnUrl: string): Promise<any> => Api('post', `/Account/register?returnUrl=${encodeURIComponent(returnUrl)}`, model, postRegisterActions);
...
export const postExternalLogin = (provider: string, returnUrl: string): Promise<any> => Api('post', `/Account/externalLogin?provider=${encodeURIComponent(provider)}&returnUrl=${encodeURIComponent(returnUrl)}`, null, postExternalLoginActions);
...
export const getExternalLoginCallback = (returnUrl: string, remoteError: string): Promise<any> => Api('get', `/Account/externalLoginCallback?returnUrl=${encodeURIComponent(returnUrl)}&remoteError=${encodeURIComponent(remoteError)}`, null, getExternalLoginCallbackActions);
...
export const postExternalLoginConfirmation = (model: ExternalLoginViewModel, returnUrl: string): Promise<any> => Api('post', `/Account/externalLoginConfirmation?returnUrl=${encodeURIComponent(returnUrl)}`, model, postExternalLoginConfirmationActions);
...
export const getResetPassword = (code: string): Promise<any> => Api('get', `/Account/resetPassword?code=${encodeURIComponent(code)}`, null, getResetPasswordActions);
