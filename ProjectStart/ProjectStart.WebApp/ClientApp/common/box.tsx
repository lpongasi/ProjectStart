...
export class BoxProps {
    public constructor(boxProps: BoxProps) {
        ...
        this.ImageBackgroundUrl = boxProps.ImageBackgroundUrl && this.BoxType != BoxGroup ? boxProps.ImageBackgroundUrl : this.BoxType != BoxGroup ? '/images/test.jpg' : null;
                    ...
                    {this.props.BoxType != BoxGroup
                        ? <div className="content">
                            ...
                            <div className="box-inputs">
                                ...
                                {(this.state.IsModified && <a className="waves-effect waves-light btn btn-save input-field"><span className="fa fa-save"></span> Save Changes</a>)}
                            </div>
                        </div>
