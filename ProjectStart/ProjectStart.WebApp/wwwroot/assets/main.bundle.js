...
var store_1 = __webpack_require__(271);
var route_1 = __webpack_require__(276);
...
var logger_1 = __webpack_require__(272);
var reducer_1 = __webpack_require__(274);
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_logger_1 = __webpack_require__(273);
...
Object.defineProperty(exports, "__esModule", { value: true });
var redux_1 = __webpack_require__(24);
var manageItem_1 = __webpack_require__(275);
var loading_1 = __webpack_require__(283);
var allreducers = redux_1.combineReducers({
    manageItem: manageItem_1.default,
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(5);
var react_router_dom_1 = __webpack_require__(61);
var navigation_1 = __webpack_require__(277);
var home_1 = __webpack_require__(279);
var manage_item_1 = __webpack_require__(280);
...
var Navigation = (function (_super) {
    ...
    Navigation.prototype.componentDidMount = function () {
        ...
        api_1.api('TEST', api_1.MethodType.Get, 'api/category', { name: 'LOKI' });
    };
...
var dispatcher = function (type, payload) {
...
exports.api = function (dispatchPrefix, methodType, url, data) {
    ...
    store_1.default.dispatch(dispatcher(dispatchPrefix + "_" + common_1.StateLifeCycle.Started));
    store_1.default.dispatch(dispatcher("LOADING_" + common_1.StateLifeCycle.Started));
    $.ajax({
        method: methodType,
        url: url,
        dataType: 'json',
        ...
        .done(function (data) {
        store_1.default.dispatch(dispatcher(dispatchPrefix + "_" + common_1.StateLifeCycle.Success, data));
        store_1.default.dispatch(dispatcher("LOADING_" + common_1.StateLifeCycle.End));
    })
        .fail(function (jqXhr, textStatus, errorThrown) {
        store_1.default.dispatch(dispatcher(dispatchPrefix + "_" + common_1.StateLifeCycle.Error, __assign({}, jqXhr.responseJSON, { errorThrown: errorThrown })));
        store_1.default.dispatch(dispatcher("LOADING_" + common_1.StateLifeCycle.Error, __assign({}, jqXhr.responseJSON, { errorThrown: errorThrown })));
    })
        .always(function () {
        store_1.default.dispatch(dispatcher(dispatchPrefix + "_" + common_1.StateLifeCycle.End));
        store_1.default.dispatch(dispatcher("LOADING_" + common_1.StateLifeCycle.End));
    });
};
